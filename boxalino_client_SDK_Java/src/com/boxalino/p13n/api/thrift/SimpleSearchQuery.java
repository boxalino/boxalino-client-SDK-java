/**
 * Auto generated by Thrift Compiler (0.10.0)
 *
...
public class SimpleSearchQuery implements org.apache.thrift.TBase<SimpleSearchQuery, SimpleSearchQuery._Fields>, java.io.Serializable, Cloneable, Comparable<SimpleSearchQuery> {
  ...
  private static final org.apache.thrift.protocol.TField HITS_GROUPS_AS_HITS_FIELD_DESC = new org.apache.thrift.protocol.TField("hitsGroupsAsHits", org.apache.thrift.protocol.TType.BOOL, (short)70);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new SimpleSearchQueryStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new SimpleSearchQueryTupleSchemeFactory();
  ...
  public java.util.List<Filter> filters; // required
  public boolean orFilters; // required
  public java.util.List<FacetRequest> facetRequests; // required
  public java.util.List<SortField> sortFields; // required
  public long offset; // required
  public int hitCount; // required
  public java.util.List<java.lang.String> returnFields; // required
  public java.lang.String groupBy; // required
  public boolean groupFacets; // required
  public int groupItemsCount; // required
  public java.lang.String groupItemsSort; // required
  public boolean groupItemsSortAscending; // required
  public boolean hitsGroupsAsHits; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    HITS_GROUPS_AS_HITS((short)70, "hitsGroupsAsHits");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 70: // HITS_GROUPS_AS_HITS
          return HITS_GROUPS_AS_HITS;
        default:
          return null;
      }
    }
  ...
  private static final int __HITSGROUPSASHITS_ISSET_ID = 6;
  ...
  static {
    ...
    tmpMap.put(_Fields.GROUP_ITEMS_SORT_ASCENDING, new org.apache.thrift.meta_data.FieldMetaData("groupItemsSortAscending", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.HITS_GROUPS_AS_HITS, new org.apache.thrift.meta_data.FieldMetaData("hitsGroupsAsHits", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public SimpleSearchQuery(
    ...
    long offset,
    int hitCount,
    java.util.List<java.lang.String> returnFields,
    java.lang.String groupBy,
    boolean groupFacets,
    int groupItemsCount,
    java.lang.String groupItemsSort,
    boolean groupItemsSortAscending,
    boolean hitsGroupsAsHits)
  {
    this();
    ...
    this.hitsGroupsAsHits = hitsGroupsAsHits;
    setHitsGroupsAsHitsIsSet(true);
  }
  ...
  public SimpleSearchQuery(SimpleSearchQuery other) {
    ...
    if (other.isSetFilters()) {
      java.util.List<Filter> __this__filters = new java.util.ArrayList<Filter>(other.filters.size());
    ...
    if (other.isSetFacetRequests()) {
      java.util.List<FacetRequest> __this__facetRequests = new java.util.ArrayList<FacetRequest>(other.facetRequests.size());
    ...
    if (other.isSetSortFields()) {
      java.util.List<SortField> __this__sortFields = new java.util.ArrayList<SortField>(other.sortFields.size());
    ...
    if (other.isSetReturnFields()) {
      java.util.List<java.lang.String> __this__returnFields = new java.util.ArrayList<java.lang.String>(other.returnFields);
    ...
    this.hitsGroupsAsHits = other.hitsGroupsAsHits;
  }
  ...
  public SimpleSearchQuery setIndexId(java.lang.String indexId) {
    this.indexId = indexId;
    return this;
  }
  ...
  public SimpleSearchQuery setLanguage(java.lang.String language) {
    this.language = language;
    return this;
  }
  ...
  public SimpleSearchQuery setQueryText(java.lang.String queryText) {
    this.queryText = queryText;
    return this;
  }
  ...
  public SimpleSearchQuery setFilters(java.util.List<Filter> filters) {
    this.filters = filters;
    return this;
  }
  ...
  public void unsetOrFilters() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __ORFILTERS_ISSET_ID);
  }

  /** Returns true if field orFilters is set (has been assigned a value) and false otherwise */
  public boolean isSetOrFilters() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __ORFILTERS_ISSET_ID);
  }

  public void setOrFiltersIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __ORFILTERS_ISSET_ID, value);
  }
  ...
  public void addToFacetRequests(FacetRequest elem) {
    if (this.facetRequests == null) {
      this.facetRequests = new java.util.ArrayList<FacetRequest>();
    }
    this.facetRequests.add(elem);
  }

  public java.util.List<FacetRequest> getFacetRequests() {
    return this.facetRequests;
  }

  public SimpleSearchQuery setFacetRequests(java.util.List<FacetRequest> facetRequests) {
    this.facetRequests = facetRequests;
    return this;
  }
  ...
  public void addToSortFields(SortField elem) {
    if (this.sortFields == null) {
      this.sortFields = new java.util.ArrayList<SortField>();
    }
  ...
  public SimpleSearchQuery setSortFields(java.util.List<SortField> sortFields) {
    this.sortFields = sortFields;
    return this;
  }
  ...
  public java.util.Iterator<java.lang.String> getReturnFieldsIterator() {
    return (this.returnFields == null) ? null : this.returnFields.iterator();
  }

  public void addToReturnFields(java.lang.String elem) {
    if (this.returnFields == null) {
      this.returnFields = new java.util.ArrayList<java.lang.String>();
    }
  ...
  public SimpleSearchQuery setReturnFields(java.util.List<java.lang.String> returnFields) {
    this.returnFields = returnFields;
    return this;
  }
  ...
  public SimpleSearchQuery setGroupBy(java.lang.String groupBy) {
    this.groupBy = groupBy;
    return this;
  }
  ...
  public void unsetGroupFacets() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __GROUPFACETS_ISSET_ID);
  }

  /** Returns true if field groupFacets is set (has been assigned a value) and false otherwise */
  public boolean isSetGroupFacets() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __GROUPFACETS_ISSET_ID);
  }

  public void setGroupFacetsIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __GROUPFACETS_ISSET_ID, value);
  }
  ...
  public void unsetGroupItemsCount() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __GROUPITEMSCOUNT_ISSET_ID);
  }
  ...
  public boolean isSetGroupItemsCount() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __GROUPITEMSCOUNT_ISSET_ID);
  }

  public void setGroupItemsCountIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __GROUPITEMSCOUNT_ISSET_ID, value);
  }

  public java.lang.String getGroupItemsSort() {
    return this.groupItemsSort;
  }

  public SimpleSearchQuery setGroupItemsSort(java.lang.String groupItemsSort) {
    this.groupItemsSort = groupItemsSort;
    return this;
  }
  ...
  public void unsetGroupItemsSortAscending() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __GROUPITEMSSORTASCENDING_ISSET_ID);
  }
  ...
  public boolean isSetGroupItemsSortAscending() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __GROUPITEMSSORTASCENDING_ISSET_ID);
  }

  public void setGroupItemsSortAscendingIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __GROUPITEMSSORTASCENDING_ISSET_ID, value);
  }

  public boolean isHitsGroupsAsHits() {
    return this.hitsGroupsAsHits;
  }

  public SimpleSearchQuery setHitsGroupsAsHits(boolean hitsGroupsAsHits) {
    this.hitsGroupsAsHits = hitsGroupsAsHits;
    setHitsGroupsAsHitsIsSet(true);
    return this;
  }

  public void unsetHitsGroupsAsHits() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __HITSGROUPSASHITS_ISSET_ID);
  }

  /** Returns true if field hitsGroupsAsHits is set (has been assigned a value) and false otherwise */
  public boolean isSetHitsGroupsAsHits() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __HITSGROUPSASHITS_ISSET_ID);
  }

  public void setHitsGroupsAsHitsIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __HITSGROUPSASHITS_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case FILTERS:
      if (value == null) {
        ...
        setFilters((java.util.List<Filter>)value);
      }
      break;
    ...
    case OR_FILTERS:
      if (value == null) {
        ...
        setOrFilters((java.lang.Boolean)value);
      }
      break;
    ...
    case FACET_REQUESTS:
      if (value == null) {
        ...
        setFacetRequests((java.util.List<FacetRequest>)value);
      }
      break;
    ...
    case SORT_FIELDS:
      if (value == null) {
        ...
        setSortFields((java.util.List<SortField>)value);
      }
      break;
    ...
    case RETURN_FIELDS:
      if (value == null) {
        ...
        setReturnFields((java.util.List<java.lang.String>)value);
      }
      break;
    ...
    case GROUP_ITEMS_COUNT:
      if (value == null) {
        ...
        setGroupItemsCount((java.lang.Integer)value);
      }
      break;
    ...
    case GROUP_ITEMS_SORT:
      if (value == null) {
        ...
        setGroupItemsSort((java.lang.String)value);
      }
      break;
    ...
    case GROUP_ITEMS_SORT_ASCENDING:
      if (value == null) {
        ...
        setGroupItemsSortAscending((java.lang.Boolean)value);
      }
      break;

    case HITS_GROUPS_AS_HITS:
      if (value == null) {
        unsetHitsGroupsAsHits();
      } else {
        setHitsGroupsAsHits((java.lang.Boolean)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case GROUP_FACETS:
      return isGroupFacets();

    case GROUP_ITEMS_COUNT:
      return getGroupItemsCount();

    case GROUP_ITEMS_SORT:
      return getGroupItemsSort();

    case GROUP_ITEMS_SORT_ASCENDING:
      return isGroupItemsSortAscending();

    case HITS_GROUPS_AS_HITS:
      return isHitsGroupsAsHits();
  ...
  public boolean equals(SimpleSearchQuery that) {
    ...
    boolean this_present_hitsGroupsAsHits = true;
    boolean that_present_hitsGroupsAsHits = true;
    if (this_present_hitsGroupsAsHits || that_present_hitsGroupsAsHits) {
      if (!(this_present_hitsGroupsAsHits && that_present_hitsGroupsAsHits))
        return false;
      if (this.hitsGroupsAsHits != that.hitsGroupsAsHits)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((orFilters) ? 131071 : 524287);

    hashCode = hashCode * 8191 + ((isSetFacetRequests()) ? 131071 : 524287);
    if (isSetFacetRequests())
      hashCode = hashCode * 8191 + facetRequests.hashCode();

    hashCode = hashCode * 8191 + ((isSetSortFields()) ? 131071 : 524287);
    if (isSetSortFields())
      hashCode = hashCode * 8191 + sortFields.hashCode();

    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(offset);

    hashCode = hashCode * 8191 + hitCount;

    hashCode = hashCode * 8191 + ((isSetReturnFields()) ? 131071 : 524287);
    if (isSetReturnFields())
      hashCode = hashCode * 8191 + returnFields.hashCode();

    hashCode = hashCode * 8191 + ((isSetGroupBy()) ? 131071 : 524287);
    if (isSetGroupBy())
      hashCode = hashCode * 8191 + groupBy.hashCode();

    hashCode = hashCode * 8191 + ((groupFacets) ? 131071 : 524287);

    hashCode = hashCode * 8191 + groupItemsCount;

    hashCode = hashCode * 8191 + ((isSetGroupItemsSort()) ? 131071 : 524287);
    if (isSetGroupItemsSort())
      hashCode = hashCode * 8191 + groupItemsSort.hashCode();

    hashCode = hashCode * 8191 + ((groupItemsSortAscending) ? 131071 : 524287);

    hashCode = hashCode * 8191 + ((hitsGroupsAsHits) ? 131071 : 524287);
  ...
  public int compareTo(SimpleSearchQuery other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetOrFilters()).compareTo(other.isSetOrFilters());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOrFilters()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFacetRequests()).compareTo(other.isSetFacetRequests());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFacetRequests()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSortFields()).compareTo(other.isSetSortFields());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSortFields()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetReturnFields()).compareTo(other.isSetReturnFields());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetReturnFields()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGroupFacets()).compareTo(other.isSetGroupFacets());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGroupFacets()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGroupItemsCount()).compareTo(other.isSetGroupItemsCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGroupItemsSort()).compareTo(other.isSetGroupItemsSort());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGroupItemsSort()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGroupItemsSortAscending()).compareTo(other.isSetGroupItemsSortAscending());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetHitsGroupsAsHits()).compareTo(other.isSetHitsGroupsAsHits());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHitsGroupsAsHits()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.hitsGroupsAsHits, other.hitsGroupsAsHits);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("SimpleSearchQuery(");
    boolean first = true;
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("hitsGroupsAsHits:");
    sb.append(this.hitsGroupsAsHits);
    first = false;
    sb.append(")");
    return sb.toString();
  }
  ...
  private static class SimpleSearchQueryStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SimpleSearchQueryStandardScheme getScheme() {
      return new SimpleSearchQueryStandardScheme();
    }
  }

  private static class SimpleSearchQueryStandardScheme extends org.apache.thrift.scheme.StandardScheme<SimpleSearchQuery> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, SimpleSearchQuery struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.filters = new java.util.ArrayList<Filter>(_list42.size);
                Filter _elem43;
                for (int _i44 = 0; _i44 < _list42.size; ++_i44)
                {
                  _elem43 = new Filter();
                  _elem43.read(iprot);
                  struct.filters.add(_elem43);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.facetRequests = new java.util.ArrayList<FacetRequest>(_list45.size);
                FacetRequest _elem46;
                for (int _i47 = 0; _i47 < _list45.size; ++_i47)
                {
                  _elem46 = new FacetRequest();
                  _elem46.read(iprot);
                  struct.facetRequests.add(_elem46);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sortFields = new java.util.ArrayList<SortField>(_list48.size);
                SortField _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = new SortField();
                  _elem49.read(iprot);
                  struct.sortFields.add(_elem49);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.returnFields = new java.util.ArrayList<java.lang.String>(_list51.size);
                java.lang.String _elem52;
                for (int _i53 = 0; _i53 < _list51.size; ++_i53)
                {
                  _elem52 = iprot.readString();
                  struct.returnFields.add(_elem52);
                }
                iprot.readListEnd();
              }
          ...
          case 70: // HITS_GROUPS_AS_HITS
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.hitsGroupsAsHits = iprot.readBool();
              struct.setHitsGroupsAsHitsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SimpleSearchQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.filters != null) {
        oprot.writeFieldBegin(FILTERS_FIELD_DESC);
        {
          ...
          for (Filter _iter54 : struct.filters)
          {
            _iter54.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.facetRequests != null) {
        oprot.writeFieldBegin(FACET_REQUESTS_FIELD_DESC);
        {
          ...
          for (FacetRequest _iter55 : struct.facetRequests)
          {
            _iter55.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.sortFields != null) {
        oprot.writeFieldBegin(SORT_FIELDS_FIELD_DESC);
        {
          ...
          for (SortField _iter56 : struct.sortFields)
          {
            _iter56.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.returnFields != null) {
        oprot.writeFieldBegin(RETURN_FIELDS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter57 : struct.returnFields)
          {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(HITS_GROUPS_AS_HITS_FIELD_DESC);
      oprot.writeBool(struct.hitsGroupsAsHits);
      oprot.writeFieldEnd();
  ...
  private static class SimpleSearchQueryTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SimpleSearchQueryTupleScheme getScheme() {
      return new SimpleSearchQueryTupleScheme();
    }
  }

  private static class SimpleSearchQueryTupleScheme extends org.apache.thrift.scheme.TupleScheme<SimpleSearchQuery> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, SimpleSearchQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetHitsGroupsAsHits()) {
        optionals.set(15);
      }
      ...
      if (struct.isSetFilters()) {
        {
          ...
          for (Filter _iter58 : struct.filters)
          {
            _iter58.write(oprot);
          }
        }
      ...
      if (struct.isSetFacetRequests()) {
        {
          ...
          for (FacetRequest _iter59 : struct.facetRequests)
          {
            _iter59.write(oprot);
          }
        }
      ...
      if (struct.isSetSortFields()) {
        {
          ...
          for (SortField _iter60 : struct.sortFields)
          {
            _iter60.write(oprot);
          }
        }
      ...
      if (struct.isSetReturnFields()) {
        {
          ...
          for (java.lang.String _iter61 : struct.returnFields)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.filters = new java.util.ArrayList<Filter>(_list62.size);
          Filter _elem63;
          for (int _i64 = 0; _i64 < _list62.size; ++_i64)
          {
            _elem63 = new Filter();
            _elem63.read(iprot);
            struct.filters.add(_elem63);
          }
        }
        struct.setFiltersIsSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.facetRequests = new java.util.ArrayList<FacetRequest>(_list65.size);
          FacetRequest _elem66;
          for (int _i67 = 0; _i67 < _list65.size; ++_i67)
          {
            _elem66 = new FacetRequest();
            _elem66.read(iprot);
            struct.facetRequests.add(_elem66);
          }
        }
        struct.setFacetRequestsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.sortFields = new java.util.ArrayList<SortField>(_list68.size);
          SortField _elem69;
          for (int _i70 = 0; _i70 < _list68.size; ++_i70)
          {
            _elem69 = new SortField();
            _elem69.read(iprot);
            struct.sortFields.add(_elem69);
          }
        }
        struct.setSortFieldsIsSet(true);
      }
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.returnFields = new java.util.ArrayList<java.lang.String>(_list71.size);
          java.lang.String _elem72;
          for (int _i73 = 0; _i73 < _list71.size; ++_i73)
          {
            _elem72 = iprot.readString();
            struct.returnFields.add(_elem72);
          }
        }
        struct.setReturnFieldsIsSet(true);
      }
